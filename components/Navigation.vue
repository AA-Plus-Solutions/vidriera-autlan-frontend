<template>
  <header class="header">
    <v-container>
      <!-- <h1 class="text-title">Vidriera App</h1> -->
      ...
      <div class="d-flex justify-space-between">
        ...
        <span @click="openNav()" class="d-sm-none">
        ...
        <div class="additional-routes d-flex align-center justify-end">
...
header {
  border-bottom: 1px solid #4b5267;
}
header .container {
  padding: 0 12px;
}
